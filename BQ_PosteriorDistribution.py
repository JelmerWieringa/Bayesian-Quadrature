...
# X = np.array([0.7, 1.6, 2.3, 3, 3.4, 4, 4.5])  # Figure 9
X = np.linspace(start = 0, stop = 5, num = 20)  # Figure 18 & 19
f_X = Integrand_f(X)
...
plt.ylabel(r"$f(x_i)$")
plt.tight_layout()
plt.savefig(f"Images/Histogram_IntegrateBQPosterior_Integrand_n={len(X)}.png", dpi = 300, bbox_inches = 'tight')
plt.show()


# Use the approximation by the trapezoidal rule as the "true" integral value
...
plt.ylabel(r"$f(x_i)$")
plt.tight_layout()
plt.savefig(f"Images/Histogram_IntegrateBQPosterior_PriorSamples_n={len(X)}.png", dpi = 300, bbox_inches = 'tight')
plt.show()
...
# Note: We use the Freedman-Diaconis Rule for optimal bin width
...
plt.savefig(f"Images/Histogram_IntegrateBQPosterior_{n_samples1}_n={len(X)}.png", dpi = 300, bbox_inches = 'tight')
plt.show()
...
plt.hist(PosteriorSamples2["IntegralSampleFunctions"], bins='fd', density = True, color = 'darkorange')
# Integral of posterior mean function
ax2.axvline(PosteriorMeanIntegral, color = 'C4', linewidth = 2, label = "Integral of Posterior Mean")
# True integral value
ax2.axvline(TrueIntegralValue, color = 'lightgreen', linewidth = 2, label = "True Integral Value")
...
plt.tight_layout()
fig.subplots_adjust(wspace = 0.15)  # Spacing between plots
plt.savefig(f"Images/Histogram_IntegrateBQPosterior_{n_samples2}_n={len(X)}.png", dpi = 300, bbox_inches = 'tight')
plt.show()
...
### Right Plot: (Approximation) Integral of Sample Functions
ax2.hist(PosteriorSamples3["IntegralSampleFunctions"], bins='fd', density = True, color = 'darkorange')
...
plt.tight_layout()
fig.subplots_adjust(wspace = 0.15)  # Spacing between plots
plt.savefig(f"Images/Histogram_IntegrateBQPosterior_{n_samples3}_n={len(X)}.png", dpi = 300, bbox_inches = 'tight')
plt.show()