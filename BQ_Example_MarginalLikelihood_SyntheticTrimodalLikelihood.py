...
from BQ_UniversalFunctions import KernelSelectionML, MLEHyperparameters
...
def PlotConvergenceEstimate(ScaleX, ScaleY, Filename):
...
### Convergence Estimate: loglog, semilogx, and linear scale
PlotConvergenceEstimate(ScaleX = 'log',    ScaleY = 'log',    Filename = 'results/BQ_ConvergenceEstimate_NumberofObservations_loglog_GMM.png')
PlotConvergenceEstimate(ScaleX = 'log',    ScaleY = 'linear', Filename = 'results/BQ_ConvergenceEstimate_NumberofObservations_semilogx_GMM.png')
PlotConvergenceEstimate(ScaleX = 'linear', ScaleY = 'linear', Filename = 'results/BQ_ConvergenceEstimate_NumberofObservations_plot_GMM.png')
